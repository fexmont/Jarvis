class JarvisCanvas {
    ...
    drawMainRing() {
        ...
        // Ring 1 — outer rotating 3-arc segments
        ctx.save();
        ctx.translate(cx, cy);
        ctx.rotate(t * 0.45);
        ...
        // Diamond corner markers (slow rotation)
        ctx.save();
        ctx.translate(cx, cy);
        ctx.rotate(t * 0.10);
        ctx.shadowBlur = 10;
    ...
    drawWaveform() {
        ...
        if (this.state === 'speaking') {
            // Smooth morphed wave for speaking: two overlapping sine shapes
            ...
            // Radial bars for listening + processing
            for (let i = 0; i < bars; i++) {
    ...
    drawCenter() {
        ...
        // Dark center fill with subtle gradient
